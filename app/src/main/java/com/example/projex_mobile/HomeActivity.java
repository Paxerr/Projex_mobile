...
//import com.example.projex_mobile.fragments.ProfileFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private LinearLayout navHome, navSpaces, navTasks, navNotifications, navUser;
    private ImageView ivHome, ivSpaces, ivTasks, ivNotifications, ivUser;
    private TextView tvHome, tvSpaces, tvTasks, tvNotifications, tvUser;
    ...
    private void initViews() {
        ...
        ivTasks = findViewById(R.id.iv_tasks);
    ...
    private void setSelectedNav(int selectedId) {
        ...
        ImageView[] icons = {ivHome, ivSpaces, ivTasks, ivNotifications, ivUser};
        TextView[] texts = {tvHome, tvSpaces, tvTasks, tvNotifications, tvUser};
